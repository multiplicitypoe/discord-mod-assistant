...
def analyze_incident(
    ...
    prompt = (
        ...
        "channel being normal beforehand unless that actually matters. Start it with the "
        "few words that matter most wrapped in ** for bold, e.g. "
        "'**Bob forwarded a scam post** into the channel. It is still up.'\n"
        "- participants: <= 4\n"
        "- signals: <= 4\n"
        "- rule_refs: <= 2\n"
