...
def analyze_incident(
    ...
    prompt = (
        ...
        "say what happened and who did it. Do not describe the channel being normal "
        "beforehand unless that actually matters. Do not use bold: it is rendered after "
        "a bold label and more bold would compete with it.\n"
