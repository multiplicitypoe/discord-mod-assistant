...
def analyze_incident(
    ...
    prompt = (
        ...
        "- summary: 1-2 sentences, <= 220 chars, plain language a moderator would use. Say what happened and where it stands now. Do not restate the headline, and do not describe the channel being normal beforehand unless that actually matters.\n"
        "- participants: <= 4\n"
        "- signals: <= 4\n"
        "- rule_refs: <= 2\n"
